...
export const ServerDetailsInfo: React.FC<ServerDetailsInfoProps> = ({
  ...
  return (
    <div className="flex justify-center">
      <div className="flex px-8 py-4 m-4 w-11/12 text-gray-app-100 bg-gray-app-600 rounded-lg">
        <div className="flex flex-col w-2/3 pr-8 p-4">
        ...
        <div
          className={`${(server.gpus?.length ?? 0) > 2 ? "w-1/2" : "w-1/3"} rounded-lg p-4 flex flex-col gap-4`}
        >
